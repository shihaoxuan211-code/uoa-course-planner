    ...
    <section className="rounded-lg border border-slate-200 bg-white p-5 shadow-card">
      ...
      <div className="mt-5 grid gap-3 text-xs sm:grid-cols-2">
        {roadmap.prerequisites.length > 0 && (
          <div>
            <p className="font-semibold text-slate-600">{t.roadmap.beforeThis} ({roadmap.prerequisites.length})</p>
        ...
        {roadmap.leadsTo.length > 0 && (
          <div>
            <p className="font-semibold text-slate-600">{t.roadmap.afterThis} ({roadmap.leadsTo.length})</p>
            <p className="mt-1 text-slate-500">
        ...
        {roadmap.allPrereqCodes.length > 0 && roadmap.prerequisites.length === 0 && (
          <div>
            <p className="font-semibold text-slate-600">{t.roadmap.prereqsNotInDataset}</p>
