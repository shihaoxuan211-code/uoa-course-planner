export const PLAN_STORAGE_KEY = "uoa-course-planner:plan";
export const COMPARE_STORAGE_KEY = "uoa-course-planner:compare";
export const COMPLETED_COURSES_KEY = "uoa-course-planner:completed-courses";
