...
const BCOM_SUBJECTS = [
  ...
  "PSYCH", "SCIGEN", "STATS",
  // Engineering
  "CHEMMAT", "CIVIL", "COMPSYS", "ELECTENG", "ENGGEN", "ENGSCI", "MECHENG", "SOFTENG",
  // Arts
...
const BCOM_COURSE_CODES = [
  ...
  // === AGGRESSIVE EXPANSION — priority subjects ===
  // CHEMMAT
  "CHEMMAT 100","CHEMMAT 121","CHEMMAT 122","CHEMMAT 200","CHEMMAT 201","CHEMMAT 202","CHEMMAT 203","CHEMMAT 204","CHEMMAT 205",
  "CHEMMAT 211","CHEMMAT 221","CHEMMAT 222","CHEMMAT 231","CHEMMAT 241","CHEMMAT 251",
  "CHEMMAT 301","CHEMMAT 302","CHEMMAT 303","CHEMMAT 304","CHEMMAT 305",
  "CHEMMAT 311","CHEMMAT 321","CHEMMAT 322","CHEMMAT 331","CHEMMAT 341","CHEMMAT 351",
  // ACCTG
  "ACCTG 101","ACCTG 151","ACCTG 201","ACCTG 251","ACCTG 255","ACCTG 260","ACCTG 270",
  "ACCTG 301","ACCTG 302","ACCTG 303","ACCTG 304","ACCTG 305",
  "ACCTG 313","ACCTG 314","ACCTG 315","ACCTG 316","ACCTG 317","ACCTG 318","ACCTG 319",
  "ACCTG 322","ACCTG 324","ACCTG 325","ACCTG 332","ACCTG 333",
  // BUSAN
  "BUSAN 100","BUSAN 205","BUSAN 206","BUSAN 301","BUSAN 303","BUSAN 304","BUSAN 305","BUSAN 306",
  // COMLAW
  "COMLAW 202","COMLAW 203","COMLAW 204","COMLAW 205","COMLAW 206","COMLAW 302",
  "COMLAW 304","COMLAW 305","COMLAW 306","COMLAW 307","COMLAW 308","COMLAW 309","COMLAW 310",
  "COMLAW 312","COMLAW 313","COMLAW 315","COMLAW 316","COMLAW 317",
  // ECON
  "ECON 101","ECON 111","ECON 141","ECON 153","ECON 222","ECON 232","ECON 242","ECON 252",
  "ECON 261","ECON 262","ECON 263","ECON 271","ECON 272","ECON 281","ECON 282",
  "ECON 303","ECON 304","ECON 305","ECON 312","ECON 313","ECON 314",
  "ECON 322","ECON 323","ECON 324","ECON 331","ECON 332","ECON 333",
  "ECON 342","ECON 343","ECON 353","ECON 354","ECON 355",
  "ECON 362","ECON 363","ECON 371","ECON 373","ECON 374",
  // FINANCE
  "FINANCE 101","FINANCE 201","FINANCE 202","FINANCE 203","FINANCE 204","FINANCE 211","FINANCE 212","FINANCE 213","FINANCE 214","FINANCE 221","FINANCE 222",
  "FINANCE 251","FINANCE 252","FINANCE 253","FINANCE 254","FINANCE 255",
  "FINANCE 301","FINANCE 302","FINANCE 303","FINANCE 304",
  "FINANCE 311","FINANCE 312","FINANCE 313","FINANCE 314",
  "FINANCE 321","FINANCE 322","FINANCE 323","FINANCE 324",
  "FINANCE 331","FINANCE 332","FINANCE 333","FINANCE 334",
  "FINANCE 341","FINANCE 342","FINANCE 352","FINANCE 353",
  "FINANCE 355","FINANCE 356","FINANCE 357","FINANCE 358","FINANCE 359",
  "FINANCE 363","FINANCE 364","FINANCE 365","FINANCE 366","FINANCE 367","FINANCE 368","FINANCE 369",
  "FINANCE 371","FINANCE 372","FINANCE 373","FINANCE 374","FINANCE 375","FINANCE 376",
  "FINANCE 381","FINANCE 382","FINANCE 384","FINANCE 385","FINANCE 386",
  // INFOSYS
  "INFOSYS 100","INFOSYS 101","INFOSYS 280","INFOSYS 281","INFOSYS 282","INFOSYS 283",
  "INFOSYS 290","INFOSYS 291","INFOSYS 292",
  "INFOSYS 301","INFOSYS 302","INFOSYS 306","INFOSYS 307","INFOSYS 308","INFOSYS 310",
  "INFOSYS 311","INFOSYS 312","INFOSYS 313","INFOSYS 314",
  "INFOSYS 322","INFOSYS 323","INFOSYS 324","INFOSYS 325",
  "INFOSYS 331","INFOSYS 332","INFOSYS 333","INFOSYS 334","INFOSYS 338",
  "INFOSYS 340","INFOSYS 342","INFOSYS 343","INFOSYS 344","INFOSYS 345",
  // INTBUS
  "INTBUS 100","INTBUS 200","INTBUS 250","INTBUS 251","INTBUS 252",
  "INTBUS 301","INTBUS 302","INTBUS 303","INTBUS 304","INTBUS 307","INTBUS 308","INTBUS 309","INTBUS 310",
  "INTBUS 311","INTBUS 312","INTBUS 313","INTBUS 314",
  // MGMT
  "MGMT 100","MGMT 101","MGMT 102","MGMT 210","MGMT 212","MGMT 213","MGMT 221","MGMT 222",
  "MGMT 231","MGMT 232","MGMT 233","MGMT 241","MGMT 242",
  "MGMT 300","MGMT 301","MGMT 303","MGMT 304","MGMT 305","MGMT 306","MGMT 307","MGMT 308",
  "MGMT 310","MGMT 311","MGMT 312","MGMT 313","MGMT 315",
  // MKTG
  "MKTG 101","MKTG 201","MKTG 204","MKTG 205","MKTG 206","MKTG 207","MKTG 208",
  "MKTG 209","MKTG 210","MKTG 211",
  "MKTG 300","MKTG 304","MKTG 305","MKTG 306","MKTG 307","MKTG 308","MKTG 310","MKTG 311","MKTG 312",
  "MKTG 313","MKTG 314","MKTG 315","MKTG 316","MKTG 317",
  // OPSMGT
  "OPSMGT 100","OPSMGT 101","OPSMGT 250","OPSMGT 251","OPSMGT 260","OPSMGT 270",
  "OPSMGT 300","OPSMGT 301","OPSMGT 302","OPSMGT 303",
  "OPSMGT 310","OPSMGT 311","OPSMGT 312","OPSMGT 313",
  "OPSMGT 350","OPSMGT 351","OPSMGT 352","OPSMGT 353",
  "OPSMGT 372","OPSMGT 373","OPSMGT 374","OPSMGT 375",
  "OPSMGT 380","OPSMGT 381","OPSMGT 382","OPSMGT 383",
  // PROPERTY
  "PROPERTY 100","PROPERTY 101","PROPERTY 103","PROPERTY 104","PROPERTY 105",
  "PROPERTY 201","PROPERTY 202","PROPERTY 203","PROPERTY 204","PROPERTY 205",
  "PROPERTY 212","PROPERTY 213","PROPERTY 214","PROPERTY 215",
  "PROPERTY 222","PROPERTY 223","PROPERTY 224","PROPERTY 225",
  "PROPERTY 232","PROPERTY 233","PROPERTY 234",
  "PROPERTY 242","PROPERTY 243","PROPERTY 244",
  "PROPERTY 252","PROPERTY 253",
  "PROPERTY 272","PROPERTY 273",
  "PROPERTY 282","PROPERTY 283",
  "PROPERTY 301","PROPERTY 302","PROPERTY 303","PROPERTY 304","PROPERTY 305","PROPERTY 306","PROPERTY 307",
  "PROPERTY 312","PROPERTY 313","PROPERTY 314",
  "PROPERTY 321","PROPERTY 322",
  "PROPERTY 331","PROPERTY 332",
  "PROPERTY 341","PROPERTY 342",
  "PROPERTY 352","PROPERTY 353",
  "PROPERTY 362","PROPERTY 363",
  "PROPERTY 372","PROPERTY 373",
  // BUSINESS
  "BUSINESS 100","BUSINESS 101","BUSINESS 102","BUSINESS 103","BUSINESS 104","BUSINESS 105",
  "BUSINESS 110","BUSINESS 113","BUSINESS 116","BUSINESS 117","BUSINESS 118","BUSINESS 119",
  "BUSINESS 200","BUSINESS 201","BUSINESS 204","BUSINESS 205","BUSINESS 206","BUSINESS 207","BUSINESS 208","BUSINESS 209",
  "BUSINESS 300","BUSINESS 302","BUSINESS 303","BUSINESS 304","BUSINESS 305",
  // CIVIL
  "CIVIL 100","CIVIL 101","CIVIL 102",
  "CIVIL 210","CIVIL 211","CIVIL 212","CIVIL 213","CIVIL 214","CIVIL 215",
  "CIVIL 220","CIVIL 221","CIVIL 222","CIVIL 223","CIVIL 224","CIVIL 225",
  "CIVIL 230","CIVIL 231","CIVIL 232","CIVIL 233",
  "CIVIL 240","CIVIL 241",
  "CIVIL 308","CIVIL 309",
  "CIVIL 310","CIVIL 311","CIVIL 312","CIVIL 313","CIVIL 314","CIVIL 315",
  "CIVIL 320","CIVIL 321","CIVIL 322","CIVIL 323","CIVIL 324","CIVIL 325",
  "CIVIL 330","CIVIL 331","CIVIL 332","CIVIL 333","CIVIL 334",
  "CIVIL 340","CIVIL 341",
  // ENGGEN
  "ENGGEN 100","ENGGEN 106","ENGGEN 107","ENGGEN 108","ENGGEN 109",
  "ENGGEN 110","ENGGEN 111","ENGGEN 112","ENGGEN 113","ENGGEN 114",
  "ENGGEN 115","ENGGEN 116","ENGGEN 117","ENGGEN 118","ENGGEN 119",
  "ENGGEN 205","ENGGEN 206","ENGGEN 207","ENGGEN 208",
  "ENGGEN 209","ENGGEN 210","ENGGEN 211",
  "ENGGEN 304","ENGGEN 305","ENGGEN 306","ENGGEN 307","ENGGEN 308","ENGGEN 309",
  // ENGSCI
  "ENGSCI 100","ENGSCI 101","ENGSCI 102","ENGSCI 103",
  "ENGSCI 212","ENGSCI 215","ENGSCI 216","ENGSCI 217","ENGSCI 218","ENGSCI 219",
  "ENGSCI 220","ENGSCI 221","ENGSCI 222","ENGSCI 224","ENGSCI 225",
  "ENGSCI 230","ENGSCI 231","ENGSCI 232","ENGSCI 233",
  "ENGSCI 316","ENGSCI 317","ENGSCI 318","ENGSCI 319",
  "ENGSCI 320","ENGSCI 321","ENGSCI 322","ENGSCI 323",
  // ELECTENG
  "ELECTENG 100","ELECTENG 102","ELECTENG 103",
  "ELECTENG 206","ELECTENG 207","ELECTENG 208","ELECTENG 209","ELECTENG 210",
  "ELECTENG 211","ELECTENG 212","ELECTENG 213",
  "ELECTENG 307","ELECTENG 308","ELECTENG 309","ELECTENG 310",
  "ELECTENG 311","ELECTENG 312","ELECTENG 313","ELECTENG 314",
  // MECHENG
  "MECHENG 100","MECHENG 101","MECHENG 102",
  "MECHENG 205","MECHENG 206","MECHENG 207","MECHENG 208","MECHENG 209",
  "MECHENG 210","MECHENG 211","MECHENG 212","MECHENG 213",
  "MECHENG 306","MECHENG 307","MECHENG 308","MECHENG 309","MECHENG 310",
  "MECHENG 311","MECHENG 312","MECHENG 313","MECHENG 314",
  // SOFTENG
  "SOFTENG 100","SOFTENG 101","SOFTENG 200","SOFTENG 201","SOFTENG 202","SOFTENG 203","SOFTENG 204","SOFTENG 205",
  "SOFTENG 250","SOFTENG 251","SOFTENG 252",
  "SOFTENG 280","SOFTENG 281","SOFTENG 282","SOFTENG 284","SOFTENG 285",
  "SOFTENG 300","SOFTENG 301","SOFTENG 302","SOFTENG 303","SOFTENG 304","SOFTENG 305",
  "SOFTENG 306","SOFTENG 307","SOFTENG 308","SOFTENG 309","SOFTENG 310",
  "SOFTENG 352",
  // COMPSCI
  "COMPSCI 105","COMPSCI 107","COMPSCI 111",
  "COMPSCI 200","COMPSCI 201","COMPSCI 202","COMPSCI 203","COMPSCI 204","COMPSCI 205","COMPSCI 206","COMPSCI 207","COMPSCI 208",
  "COMPSCI 242","COMPSCI 250","COMPSCI 255","COMPSCI 280","COMPSCI 281","COMPSCI 282",
  "COMPSCI 300","COMPSCI 301","COMPSCI 302","COMPSCI 303","COMPSCI 304","COMPSCI 305",
  "COMPSCI 311","COMPSCI 312","COMPSCI 317","COMPSCI 318",
  "COMPSCI 321","COMPSCI 322","COMPSCI 323","COMPSCI 324",
  "COMPSCI 330","COMPSCI 332","COMPSCI 333","COMPSCI 334",
  "COMPSCI 341","COMPSCI 342","COMPSCI 343","COMPSCI 344",
  "COMPSCI 352","COMPSCI 353","COMPSCI 354","COMPSCI 355",
  "COMPSCI 362","COMPSCI 363","COMPSCI 364","COMPSCI 365","COMPSCI 366",
  "COMPSCI 368","COMPSCI 370","COMPSCI 371","COMPSCI 372","COMPSCI 374",
  // BIOSCI
  "BIOSCI 100","BIOSCI 104","BIOSCI 105",
  "BIOSCI 209","BIOSCI 211","BIOSCI 212","BIOSCI 213","BIOSCI 214","BIOSCI 215",
  "BIOSCI 220","BIOSCI 221","BIOSCI 222","BIOSCI 223",
  "BIOSCI 311","BIOSCI 312","BIOSCI 313","BIOSCI 314","BIOSCI 315","BIOSCI 316","BIOSCI 317","BIOSCI 318","BIOSCI 319",
  "BIOSCI 320","BIOSCI 321","BIOSCI 322","BIOSCI 323","BIOSCI 324","BIOSCI 325",
  "BIOSCI 330","BIOSCI 331","BIOSCI 332","BIOSCI 333","BIOSCI 334","BIOSCI 335",
  // CHEM
  "CHEM 100","CHEM 110G",
  "CHEM 200","CHEM 201","CHEM 202","CHEM 203","CHEM 204","CHEM 205",
  "CHEM 211","CHEM 212","CHEM 213",
  "CHEM 231","CHEM 232",
  "CHEM 241","CHEM 242",
  "CHEM 252","CHEM 253","CHEM 254","CHEM 255","CHEM 256",
  "CHEM 261","CHEM 262","CHEM 263","CHEM 264","CHEM 265",
  "CHEM 311","CHEM 312","CHEM 313",
  "CHEM 321","CHEM 322","CHEM 323",
  "CHEM 331","CHEM 332",
  "CHEM 341","CHEM 342",
  "CHEM 352","CHEM 353","CHEM 354",
  "CHEM 361","CHEM 362","CHEM 363",
  // PHYSICS
  "PHYSICS 101","PHYSICS 102","PHYSICS 103","PHYSICS 104","PHYSICS 105",
  "PHYSICS 110","PHYSICS 111","PHYSICS 112",
  "PHYSICS 200","PHYSICS 204","PHYSICS 205","PHYSICS 206","PHYSICS 207","PHYSICS 208","PHYSICS 209",
  "PHYSICS 220","PHYSICS 221","PHYSICS 222",
  "PHYSICS 242","PHYSICS 243","PHYSICS 244",
  "PHYSICS 252","PHYSICS 253","PHYSICS 254",
  "PHYSICS 262","PHYSICS 263",
  "PHYSICS 300","PHYSICS 301","PHYSICS 302","PHYSICS 303","PHYSICS 304",
  "PHYSICS 312","PHYSICS 313","PHYSICS 314",
  "PHYSICS 322","PHYSICS 323",
  "PHYSICS 331","PHYSICS 332","PHYSICS 334","PHYSICS 335",
  "PHYSICS 342","PHYSICS 343","PHYSICS 344",
  "PHYSICS 352","PHYSICS 353",
  "PHYSICS 356","PHYSICS 357","PHYSICS 358",
  // MATHS
  "MATHS 100","MATHS 101","MATHS 103","MATHS 104","MATHS 105",
  "MATHS 200","MATHS 201","MATHS 202","MATHS 203","MATHS 204","MATHS 205",
  "MATHS 211","MATHS 212","MATHS 213",
  "MATHS 220","MATHS 221","MATHS 222",
  "MATHS 231","MATHS 232","MATHS 233","MATHS 234","MATHS 235",
  "MATHS 240","MATHS 241","MATHS 242","MATHS 243","MATHS 244","MATHS 245",
  "MATHS 251","MATHS 252",
  "MATHS 255","MATHS 256",
  "MATHS 261","MATHS 262","MATHS 263","MATHS 264","MATHS 265",
  "MATHS 271","MATHS 272","MATHS 273",
  "MATHS 300","MATHS 301",
  "MATHS 310","MATHS 311","MATHS 312","MATHS 313","MATHS 314",
  "MATHS 321","MATHS 322","MATHS 323","MATHS 324",
  "MATHS 330","MATHS 331",
  "MATHS 342","MATHS 343","MATHS 344",
  "MATHS 351","MATHS 354","MATHS 355",
  "MATHS 364","MATHS 365",
  // STATS
  "STATS 100","STATS 103","STATS 104","STATS 105",
  "STATS 200","STATS 209",
  "STATS 211","STATS 212","STATS 213","STATS 214","STATS 215","STATS 216","STATS 217","STATS 218","STATS 219",
  "STATS 220","STATS 221","STATS 222","STATS 223","STATS 224","STATS 225",
  "STATS 230","STATS 231","STATS 232","STATS 233",
  "STATS 240","STATS 241","STATS 242","STATS 243",
  "STATS 255","STATS 256",
  "STATS 300","STATS 309",
  "STATS 312","STATS 314","STATS 315","STATS 316","STATS 317","STATS 318","STATS 319",
  "STATS 321","STATS 322","STATS 323","STATS 324",
  "STATS 333","STATS 334","STATS 335","STATS 336","STATS 337",
  "STATS 345","STATS 346","STATS 347",
  // MEDSCI
  "MEDSCI 100","MEDSCI 101","MEDSCI 102",
  "MEDSCI 206","MEDSCI 207","MEDSCI 208","MEDSCI 209","MEDSCI 210",
  "MEDSCI 300","MEDSCI 311","MEDSCI 312","MEDSCI 313","MEDSCI 314","MEDSCI 315","MEDSCI 316","MEDSCI 317","MEDSCI 318","MEDSCI 319",
  // EARTHSCI
  "EARTHSCI 100","EARTHSCI 101","EARTHSCI 102","EARTHSCI 103","EARTHSCI 104",
  "EARTHSCI 206","EARTHSCI 207","EARTHSCI 209","EARTHSCI 210",
  "EARTHSCI 220","EARTHSCI 221","EARTHSCI 222",
  "EARTHSCI 300","EARTHSCI 306","EARTHSCI 308","EARTHSCI 309","EARTHSCI 310",
  // LAW
  "LAW 121G","LAW 131G","LAW 141G",
  "LAW 211G","LAW 212G","LAW 231G","LAW 241G","LAW 251G","LAW 252G",
  "LAW 301G","LAW 302G","LAW 303G","LAW 304G","LAW 305G","LAW 306G",
  "LAW 311G","LAW 312G","LAW 313G","LAW 314G","LAW 316G","LAW 317G","LAW 318G","LAW 319G","LAW 320G",
  // PSYCH
  "PSYCH 100","PSYCH 101","PSYCH 102","PSYCH 103","PSYCH 104","PSYCH 105","PSYCH 106","PSYCH 107",
  "PSYCH 208","PSYCH 209","PSYCH 210","PSYCH 211","PSYCH 212","PSYCH 213",
  "PSYCH 302","PSYCH 303","PSYCH 304","PSYCH 305","PSYCH 306","PSYCH 308","PSYCH 309","PSYCH 310",
  // POPLHLTH
  "POPLHLTH 100","POPLHLTH 102","POPLHLTH 105","POPLHLTH 106","POPLHLTH 107","POPLHLTH 108",
  "POPLHLTH 202","POPLHLTH 203","POPLHLTH 206","POPLHLTH 207","POPLHLTH 208","POPLHLTH 210",
  "POPLHLTH 211","POPLHLTH 212","POPLHLTH 213","POPLHLTH 215",
  "POPLHLTH 300","POPLHLTH 302","POPLHLTH 303","POPLHLTH 304","POPLHLTH 305","POPLHLTH 306",
  "POPLHLTH 310","POPLHLTH 311","POPLHLTH 312","POPLHLTH 313","POPLHLTH 314","POPLHLTH 315","POPLHLTH 316",
  // NURSING
  "NURSING 104","NURSING 104G","NURSING 105","NURSING 105G","NURSING 106","NURSING 106G",
  "NURSING 201","NURSING 202","NURSING 204","NURSING 205",
  "NURSING 301","NURSING 302","NURSING 303","NURSING 305","NURSING 306",
  // PHARMACY
  "PHARMACY 103","PHARMACY 104","PHARMACY 105","PHARMACY 106",
  "PHARMACY 203","PHARMACY 204","PHARMACY 205","PHARMACY 206",
  "PHARMACY 303","PHARMACY 304","PHARMACY 305","PHARMACY 306","PHARMACY 307","PHARMACY 308",
  // EDUC
  "EDUC 100","EDUC 100G","EDUC 105","EDUC 106","EDUC 107","EDUC 108","EDUC 109",
  "EDUC 110","EDUC 111","EDUC 112",
  "EDUC 200","EDUC 201","EDUC 203","EDUC 204","EDUC 206","EDUC 207","EDUC 208","EDUC 209",
  "EDUC 210","EDUC 211","EDUC 212","EDUC 213",
  "EDUC 300","EDUC 304","EDUC 308","EDUC 309","EDUC 310",
  "EDUC 311","EDUC 312","EDUC 313","EDUC 314",
  // Additional high-interest subjects
  "EXERSCI 100","EXERSCI 102","EXERSCI 104","EXERSCI 105","EXERSCI 106",
  "EXERSCI 206","EXERSCI 207","EXERSCI 208","EXERSCI 209",
  "EXERSCI 306","EXERSCI 307","EXERSCI 308",
  "FOODSCI 101","FOODSCI 102","FOODSCI 103","FOODSCI 104","FOODSCI 105",
  "FOODSCI 203","FOODSCI 204","FOODSCI 205",
  "FOODSCI 304","FOODSCI 305","FOODSCI 306",
  "ENVSCI 100","ENVSCI 102","ENVSCI 103","ENVSCI 104","ENVSCI 105",
  "ENVSCI 200","ENVSCI 204","ENVSCI 205","ENVSCI 206",
  "ENVSCI 300","ENVSCI 304","ENVSCI 305",
  "MARINE 101","MARINE 102","MARINE 201","MARINE 301",
  "GEOG 100","GEOG 104","GEOG 202","GEOG 203","GEOG 204","GEOG 205",
  "GEOG 206","GEOG 207","GEOG 208",
  "GEOG 300","GEOG 301","GEOG 302","GEOG 303","GEOG 304","GEOG 305","GEOG 306","GEOG 307"
];
...
function parseCoursePage(course: ParsedCourseCode, page: FetchedPage): ImportedCourse {
  ...
  importedCourse.dataQuality = getDataQuality(importedCourse);

  // Apply fallback values for basic records
  if (importedCourse.dataQuality === "basic") {
    if (!importedCourse.description) importedCourse.description = "No detailed course description found yet.";
    if (!importedCourse.prerequisites) importedCourse.prerequisites = "No prerequisite information found.";
    if (!importedCourse.restrictions) importedCourse.restrictions = "No restriction information found.";
    if (!importedCourse.workload) importedCourse.workload = "No workload information found.";
  }
...
function getInvalidImportedCourseReason(course: ImportedCourse) {
  ...
  // Accept basic records — only code + title + stage minimum required
  // Missing points/description/assessments are OK for basic records
  return undefined;
}

/** Determine data quality level based on extracted fields */
function getDataQuality(course: ImportedCourse): "full" | "basic" {
  const hasPoints = hasExtractedValue(course.points);
  const hasDesc = hasExtractedValue(course.description);
  const hasAssess = hasExtractedValue(course.assessments) && (course.assessments?.length ?? 0) > 0;
  const hasWorkload = hasExtractedValue(course.workload);

  // Full: has points AND (description OR assessments OR workload)
  if (hasPoints && (hasDesc || hasAssess || hasWorkload)) return "full";
  return "basic";
}
...
async function importCourses() {
  ...
  // Merge with existing data — preserve full records from previous imports
  let existingCourses: ImportedCourse[] = [];
  try {
    if (fs.existsSync(OUTPUT_PATH)) {
      existingCourses = JSON.parse(fs.readFileSync(OUTPUT_PATH, "utf8"));
    }
  } catch { /* ignore */ }

  const existingMap = new Map<string, ImportedCourse>();
  for (const c of existingCourses) {
    if (c.code && c.dataQuality === "full") {
      existingMap.set(c.code, c);
    }
  }

  // Merge: imported courses replace matched codes, existing full records are preserved
  const mergedMap = new Map<string, ImportedCourse>();
  // Existing full records first (lower priority for basic, higher for full)
  for (const [code, course] of existingMap) {
    mergedMap.set(code, course);
  }
  // Imported courses override (but only full can override existing full; basic cannot override existing full)
  for (const course of importedCourses) {
    const existing = course.code ? mergedMap.get(course.code) : undefined;
    if (existing && existing.dataQuality === "full" && course.dataQuality === "basic") {
      // Don't overwrite existing full with new basic
      console.log(`Preserving existing full record for ${course.code}, skipping new basic import.`);
      continue;
    }
    if (course.code) mergedMap.set(course.code, course);
  }

  const finalCourses = [...mergedMap.values()].sort((a, b) => (a.code ?? "").localeCompare(b.code ?? ""));

  fs.mkdirSync(path.dirname(OUTPUT_PATH), { recursive: true });
  fs.writeFileSync(OUTPUT_PATH, `${JSON.stringify(finalCourses, null, 2)}\n`, "utf8");
  console.log(`Imported ${finalCourses.length} courses to ${OUTPUT_PATH} (${finalCourses.filter(c => c.dataQuality === "full").length} full, ${finalCourses.filter(c => c.dataQuality === "basic").length} basic)`);
  const importedStats = `Total course codes attempted: ${stats.attemptedCourseCodes.length}
Successful imports: ${stats.successfulCourseCodes.length}
Failed imports: ${stats.failedImports.length}
Skipped duplicates: ${stats.skippedDuplicates.length}`;
